...
- Source: download only from the official GitHub Releases page ([how to additionally verify the release's zip file integrity](#how-to-additionally-verify-the-releases-zip-file-integrity))
